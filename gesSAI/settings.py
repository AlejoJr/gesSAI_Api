"""
Django settings for gesSAI project.
...
WSGI_APPLICATION = 'gesSAI.wsgi.application'
...
CRONJOBS = [
    ('*/1 * * * *', "apps.backend.start.sai", '>> /Users/alejojr/PycharmProjects/TFM/gesSAI/logs/debug.log')
]
